...
return {
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- NOTE: Removed fidget.nvim - Neovim 0.10+ has native LSP progress handling
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Hover over the word under your cursor.
          ...
          -- NOTE: Categorized under <leader>tl for LSP toggles
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettierd',  -- JS/TS formatter daemon (used by conform)
        'eslint_d',   -- ESLint daemon (used by conform/diagnostics)
      })
